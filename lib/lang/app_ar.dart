const Map<String, String> lnAr = {
  ...
  "Sign up to start your food adventure with Air Menu Ai":
      "سجّل لبدء مغامرة طعامك مع customer",
  ...
  "To provide the best dining experience, allow Air Menu Ai to access your location.":
      "لتوفير أفضل تجربة طعام، اسمح لـ customer بالوصول إلى موقعك.",
  ...
  "Invite your friends to sign up with customer using your code, and you’ll earn after their Success the first order! 💸🍔":
      "أحل صديقك واكسب",
  "Share Code": "كل🎉",
  "Hey there, thanks for choosing customer. Hope you love our product. If you do, share it with your friends using code":
      "ادعُ الأصدقاء والشركات",
  "Timing is not added by restaurant":
      "ادعُ أصدقاءك للتسجيل في customer باستخدام الكود الخاص بك، وستربح بعد نجاحهم الطلب الأول! 💸🍔",
  "Also applicable on table booking": "شارك الكود",
  "Additional Offers":
      "مرحبًا، شكرًا لاختيارك customer. نأمل أن تحب منتجنا. إذا قمت بذلك، شاركه مع أصدقائك باستخدام الكود",
  ...
  "customer": "يرجى إدخال الحد الأدنى من",
  "Get Started": "تتبع رصيدك ومعاملاتك وطرق الدفع في مكان واحد.",
  "Welcome to customer": "لم يتم العثور على المعاملة",
  "Your Favorite Food Delivered Fast!": "customer",
  "Cancel Payment": "ابدأ",
  "Exit": "مرحبًا بك في customer",
  "Continue Payment": "طعامك المفضل يتم توصيله بسرعة!",
  "we Enter In": "إلغاء الدفع",
  "customer Customer": "خروج",
