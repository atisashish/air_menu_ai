        ...
        child: Obx(
          () =>
              homeController.isProductLoading.value
                  ...
                  : homeController.productList.value.isEmpty
                  ? NoDataFound()
                  : GridView.builder(
                    gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                      crossAxisCount: crossAxisCount,
                      ...
                      return InkWell(
                        onTap: () {
                          Get.to(
                            ...
                            arguments: {
                              "productId":
                                  homeController.productList.value[index].sId,
                            },
                          );
                        },
                        child: FoodCard(
                          image: homeController.productList.value[index].image,
                          title: homeController.productList.value[index].name,
                          price: "₹ 500",
                        ),
                      );
                    },
